...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        octo_models.Activity.objects.create(user=captain, type='walk', duration=20, calories=150)
        ...
        # Create Leaderboard
        octo_models.Leaderboard.objects.create(team=marvel, points=450)
        octo_models.Leaderboard.objects.create(team=dc, points=500)
